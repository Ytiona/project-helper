 ...
 */
  ...
  export default class Validator {
    ...
    constructor(rules, form, fieldOrder) {
      ...
      this.rules = rules;
      this.form = form;
      this.fieldOrder = fieldOrder || Object.keys(this.rules);
    ...
    validate() {
      ...
      const tasks = fieldOrder.map(field => {
  ...
  const rules = {
    ...
    email: [
      ...
      { validator: Validator.isEmail, message: '请输入正确的邮箱' }
    ],
    sex: [
  ...
  const validator = new Validator(rules, form);
